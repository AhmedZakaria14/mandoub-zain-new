...
const faqs: FAQItem[] = [
  {
    ...
    answer: "يمكنك بسهولة طلب التأسيس والتركيب عبر التواصل المباشر مع موظف مبيعات زين المعتمد على الرقم 0572587855 (اتصال أو واتساب). سيقوم الموظف باختيار الباقة الأنسب ورفع الطلب في النظام فوراً لضمان سرعة التركيب."
  },
  {
