...
<article dir="rtl" lang="ar">
  <img src="https://www.zain5grouter.com/images/zain-representative-rental.webp"
...
${bodyContent}
  ...
  <a href="tel:${PHONE}">
    <a href="https://wa.me/201010742430" target="_blank" rel="noopener noreferrer" style="display:inline-flex; align-items:center; justify-content:center; gap:10px; background-color:#25D366; color:white; font-weight:bold; font-size:1.5rem; text-decoration:none; padding:15px 30px; border-radius:50px; box-shadow:0 8px 20px rgba(37,211,102,0.4); margin-bottom:1rem; transition:all 0.3s; margin-top:20px;">
